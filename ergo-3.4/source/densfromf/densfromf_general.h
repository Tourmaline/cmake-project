...
int get_dens_from_fock_general(int n, /**< System size. */
			       ...
			       int use_stochastic_orbitals, /**< Use stochastic orbitals instead of standard density matrix construction.  */
			       const std::vector< std::vector<ergo_real> > stochastic_orbitals, /**< Vector of stochastic orbitals (empty vector if stochastic orbitals not used).  */
